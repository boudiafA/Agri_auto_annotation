# (grand_env_9) abood@DESKTOP-EKAJBQH:~/groundingLMM/GranD/level_3_dense_caption$
# python run.py --image_dir_path '/home/abood/groundingLMM/GranD/images' --level_2_dir_path "/home/abood/groundingLMM/GranD/output/level-2-processed_labelled" --output_dir_path "/home/abood/groundingLMM/GranD/output/level-3-vicuna-13B" --gpu_ids "0" --job_id '111' --model_path "/home/abood/groundingLMM/GranD/checkpoints/vicuna-13b-v1.5"
import os
import argparse
import subprocess
import time
