...
class CustomLevel1JsonDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        json_contents = json.load(open(f"{self.level_2_dir_path}/{os.path.splitext(image_name)[0]}.json", 'r'))
        
        box_crops, labels = {}, {}
        output_json_file_path = f"{self.output_dir_path}/{os.path.splitext(self.image_names[idx])[0]}.json"
