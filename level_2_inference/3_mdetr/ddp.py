...
class CustomImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        blip2_caption = json.load(open(f"{self.blip2_path}/{os.path.splitext(self.image_names[idx])[0]}.json", 'r'))
        blip2_caption = blip2_caption[self.image_names[idx]]['blip2']

        llava_caption = json.load(open(f"{self.llava_path}/{os.path.splitext(self.image_names[idx])[0]}.json", 'r'))
