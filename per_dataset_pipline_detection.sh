...
# Configuration
DATASETS_ROOT="/mnt/e/Desktop/AgML/datasets_sorted/detection"
OUTPUTS_ROOT="/mnt/e/Desktop/AgML/AgriDataset_GranD_annotation/detection"
...
process_image_directory() {
    ...
    run_in_scoped_env fastvlm level_1_inference/gemma3 \
        ...
        --descriptions_json "../../detailed_class_caption/detection/species_discription_cleaned.json" \
