...
class OVSAMHead(BaseModule):
    ...
    def __init__(
        ...
        if self.with_label_token:
            # ov_path = os.path.join(os.path.expanduser('/home/abood/groundingLMM/GranD/level_1_inference/9_ov_sam/models/'), f"{ov_classifier_name}.pth")
            ov_path = "/home/abood/groundingLMM/GranD/level_1_inference/9_ov_sam/models/" + f"{ov_classifier_name}.pth"
