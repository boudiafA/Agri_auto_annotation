# (grand_env_5) abood@DESKTOP-EKAJBQH:~/groundingLMM/GranD/level_1_inference/9_ov_sam$
# python launch_ov_sam_multi_gpu_inference.py --image_dir_path "/home/abood/groundingLMM/GranD/images" --output_dir_path "/home/abood/groundingLMM/GranD/output" --sam_annotations_dir "/home/abood/groundingLMM/GranD/checkpoints" --gpu_ids "0"
import os
import argparse
import subprocess
import time
