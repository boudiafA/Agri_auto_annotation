# (grand_env_1) abood@DESKTOP-EKAJBQH:~/groundingLMM/GranD/level_1_inference/6_owl_vit$
# python launch_owl_vit_multi_gpu_inference.py --image_dir_path "/home/abood/groundingLMM/GranD/images" --output_dir_path "/home/abood/groundingLMM/GranD/output" --tags_dir_path "/home/abood/groundingLMM/GranD/output" --gpu_ids "0"

# python launch_owl_vit_multi_gpu_inference.py --image_dir_path "/mnt/e/Desktop/AgML/datasets_sorted/detection/apple_detection_usa/images" --output_dir_path "/mnt/e/Desktop/AgML/AgriDataset_GranD_annotation/detection/apple_detection_usa" --tags_dir_path "/mnt/e/Desktop/AgML/AgriDataset_GranD_annotation/detection/apple_detection_usa" --gpu_ids "0"
...
def launch_owl_vit(image_names_txt_path, gpu_id, image_dir_path, output_dir_path, tags_dir_path):
    """Invoke the predict_owl_vit.py script."""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Run OWL-ViT prediction across multiple GPUs.")
...
def main():
    ...
    for i, gpu_id in enumerate(gpu_ids):
        ...
        p = Process(target=launch_owl_vit,
