...
dataloader.train.dataset.names = "lvis_v1_train" #"Agri_train"
...
dataloader.test.dataset.names = "lvis_v1_val" #"Agri_val"
...
model.roi_heads.update(
    ...
    box_predictors=[
        L(FastRCNNOutputLayers)(
            ...
            # )
            # get_fed_loss_cls_weights=lambda: [1.0] * 30  # Disable federated loss for custom dataset
            get_fed_loss_cls_weights=lambda: torch.ones(30, dtype=torch.float32)
        )
